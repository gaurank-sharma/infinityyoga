  ...
  return (
    <>
      <div className="fixed top-2/3 right-1 md:right-3 flex flex-col space-y-3 items-center transform -translate-y-1/2 z-10">
        ...
        {/* Email Icon */}
        <a
          href={`mailto:infinityyoga078@gmail.com?subject=Inquiry from Website Visitor&body=Namaste,%0D%0A%0D%0AI am reaching out regarding your Yoga healing services. Please guide me on how to get started.%0D%0A%0D%0AThank you,%0D%0A[Your Name]`}
